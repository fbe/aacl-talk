...
public class SyntheticClassLoader extends ClassLoader {
    ...
    char[] greeterClassBytes = new char[]{
        ...
        0x65, 0x72, 0x2f, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x43, 0x6c, 0x61, 0x61, 0x73,
    ...
    public Class<?> createSyntheticGreeterClass(){
        return defineClass("name.felixbecker.talks.classloader.GreeterClaas", charToByteArray(greeterClassBytes), 0, greeterClassBytes.length);
    }
